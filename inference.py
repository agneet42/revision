...
prompt = "a bicycle on the bottom of a chicken"
...
revision_image = 'assets/a_bicycle_on_the_bottom_of_a_chicken_revision.png' # image from REVISION
...
image[0].save("assets/a_bicycle_on_the_bottom_of_a_chicken.png")